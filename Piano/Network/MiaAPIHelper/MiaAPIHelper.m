...
+ (void)changeBio:(NSString *)bio
    ...
    NSMutableDictionary *dictValues = [[NSMutableDictionary alloc] init];
    [dictValues setValue:bio forKey:MiaAPIKey_Bio];
    
    [dictValues setValue:[UIDevice currentDevice].systemName forKey:MiaAPIKey_Platform];
    [dictValues setValue:[UIDevice currentDevice].systemVersion forKey:MiaAPIKey_OSVersion];
    
    MiaRequestItem *requestItem = [[MiaRequestItem alloc] initWithCommand:MiaAPICommand_User_Bio
                                                               parameters:dictValues
                                                            completeBlock:completeBlock
                                                             timeoutBlock:timeoutBlock];
    [[WebSocketMgr standard] sendWitRequestItem:requestItem];
...
+ (void)getGiftTopListWithRoomID:(NSString *)roomID
    ...
    MiaRequestItem *requestItem = [[MiaRequestItem alloc] initWithCommand:MiaAPICommand_Live_GetGiftTopList
                                                               parameters:dictValues
                                                            completeBlock:completeBlock
                                                             timeoutBlock:timeoutBlock];
    [[WebSocketMgr standard] sendWitRequestItem:requestItem];
...
+ (void)refetchLiveWithCompleteBlock:(MiaRequestCompleteBlock)completeBlock
    ...
    MiaRequestItem *requestItem = [[MiaRequestItem alloc] initWithCommand:MiaAPICommand_Live_ReFetch
                                                               parameters:dictValues
                                                            completeBlock:completeBlock
                                                             timeoutBlock:timeoutBlock];
    [[WebSocketMgr standard] sendWitRequestItem:requestItem];
