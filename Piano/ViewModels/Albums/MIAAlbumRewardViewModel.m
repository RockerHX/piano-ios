...
CGFloat const kAlbumRewardTopSpaceDistance = 20.; //top的是间距大小
...
CGFloat const kButtonToAlbumInfoViewSpaceDistance = 60.; //pop按钮到专辑信息视图的间距
CGFloat const kAlbumInfoViewHeight = 150.; //专辑信息视图的高度
CGFloat const kAlbumInfoImageViewWidth = 130.;//专辑信息视图中图片的宽度.
